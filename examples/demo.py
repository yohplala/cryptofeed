...
from cryptofeed.exchanges import (EXX, FTX, Binance, Bitfinex, Bitmex, Bitmax, Bitstamp, Bittrex, Coinbase, Gateio, Gemini,
...
def main():
    ...
    """
    .add_feed(Gateio(pairs=['BTC-USDT', 'ETH-USDT'], channels=[TRADES, L2_BOOK], callbacks={TRADES: TradeCallback(trade), L2_BOOK: BookCallback(book)}))
    ...
    """
    f.add_feed(Bitmax(config={L2_BOOK: ['BTC-USDT'], TRADES: ['ETH-BTC']}, callbacks={TRADES: TradeCallback(trade), L2_BOOK: BookCallback(book)}))
